...
class Actor:
    ...
    def __init__(
        ...
        if model_path == None:
            ...
            l1 = Dense(400, kernel_initializer='lecun_normal', activation='selu', name="h1")(state_input)
            latent_sde = Dense(300, kernel_initializer='lecun_normal', activation='selu', name="latent_sde")(l1)
...
class Critic:
    ...
    def __init__(
        ...
        if model_path == None:
            ...
            l1 = Dense(400, kernel_initializer='lecun_normal', activation='selu', name="h1")(merged)
            l2 = Dense(300, kernel_initializer='lecun_normal', activation='selu', name="h2")(l1)
